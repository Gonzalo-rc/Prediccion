...
```
Donde el T1 corresponde al primer trimestre de todos los años de la muestra, T2 al segundo trimestre y viceversa.
...
```
Elegimos el modelo ARIMA porque tiene un menor MAPE respecto el ETS (8.28 respecto a 8.67), por lo que elegimos este modelo.
...
![](https://images.macrumors.com/t/yBfxnPiu70RhJAPuY2CPI1kftH8=/1600x0/article-new/2017/08/Screen-Shot-2017-08-01-at-4.36.03-PM.jpg)
En este gráfico observamos los ingresos por dispositivo para la compañía Apple, donde merece la pena destcar con gran parte de los beneficios obtenidos por este gigante,provienen del iPhone , el cual aumenta sus beneficios conforme pasan los años,no obstante también se observa que a medida que transcurre el año se llega a un pico y después se disminuye, esto se puede deber a la salida al mercado de los iPhones y iPads, que en el primer caso es sobre septiembre y en el segundo en marzo, donde los ingresos aumentan a la salida  y se mantienen, y  posteriormente caen.
